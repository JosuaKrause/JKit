...
public final class IniReader {
   ...
   * 
   * @param f The file to interpret as INI.
   * @return The newly created {@link IniReader}.
   * @throws FileNotFoundException If this file was not found.
   */
  ...
  /**
   * Guarantees that an IniReader for a given file is created even when the file
   * does not exist.
   * 
   * @param f The file.
   * @param autoLearn Whether the IniReader should learn from default values.
   *          This option can be hazardous regarding fields that are interpreted
   *          in multiple ways.
   ...
   * 
   * @throws IllegalStateException When there is no associated file.
   * @throws IOException When there is a problem with the associated file.
  ...
  public void writeIni(final PrintWriter pw) {
    ...
    final Map<String, SortedSet<Entry>> areas =
        new HashMap<String, SortedSet<Entry>>();
  ...
  /**
   * Sets a field in the INI file. Note that all Strings will be trimmed.
   * 
   * @param area The area name. The name in [box brackets].
   * @param name The actual name of the value.
   * @param value The value.
   * @throws IllegalArgumentException When the area or the name is incorrect.
   */
  public void set(final String area, final String name, final String value) {
    if(area.contains("]")) throw new IllegalArgumentException(
        "invalud area name: " + area);
    if(name.contains("=")) throw new IllegalArgumentException("invalid name: "
        + name);
   ...
   */
  public void setInstance(final String area, final String name,
      final Object obj) {
   ...
   * @param area The area name. The name in [box brackets].
   * @param name The actual name of the value.
   * @param arr The array content -- note that all elements get trimmed.
   * @param delimiter The delimiter to use.
   * @throws IllegalArgumentException When the area or the name is incorrect or
   *           when the array contained the delimiter.
   */
   ...
   * @param area The area name. The name in [box brackets].
   * @param name The actual name of the value.
   * @param arr The array content -- note that all elements get trimmed. The
   *          default delimiter is used.
   * @throws IllegalArgumentException When the area or the name is incorrect or
   *           when the array contained the default delimiter.
   ...
   * @param area The area name. The name in [box brackets].
   * @param name The actual name of the value.
   * @return The value of the given name interpreted as number or 0 if it could
   ...
   *         steps. If the value does not exist return <code>false</code>. If it
   *         exists and it can be interpreted as a number return
   ...
   * @param loadedType The class to instantiate.
   ...
   * @param superType The super class of the returned object, i.e. the type
   *          <code>&lt;T&gt;</code>.
   * @return An object of type <code>&lt;T&gt;</code> created by the default
   *         constructor or <code>null</code>. <code>null</code> is returned
   *         when
   ...
   * @param superType The super class of the returned object, i.e. the type
   *          <code>&lt;T&gt;</code>.
   * @param defaultValue The default class name that should be loaded if the
   *          field can not be interpreted as class name. Note that the method
   *          still can fail with a <code>null</code> value as stated below.
   * @return An object of type <code>&lt;T&gt;</code> created by the default
   *         constructor or <code>null</code>. <code>null</code> is returned
   *         when
   *         <ul>
   ...
   * @param superType The super class of the returned object, i.e. the type
   *          <code>&lt;T&gt;</code>.
   * @param defaultClass The default class that should be loaded if the field
   *          can not be interpreted as class name. Note that the method still
   *          can fail with a <code>null</code> value as stated below. As
   *          opposed to {@link #getInstance(String, String, Class, String)} the
   *          default class file is always loaded - even when no instance is
   *          created.
   * @return An object of type <code>&lt;T&gt;</code> created by the default
   *         constructor or <code>null</code>. <code>null</code> is returned
   *         when
   ...
   * value of the field can be distinguished with being a valid return value or
   * an error.
   * 
   * @author Joschi <josua.krause@googlemail.com>
  ...
  private static final class Result<T> {
     ...
     * 
     * @param obj The valid value that may be <code>null</code>.
     */
   ...
   * @param area The area name. The name in [box brackets].
   * @param name The actual name of the value.
   * @param converter The converter to convert the String into the Object.
   * @return The object or <code>null</code> if the conversion has failed or the
   *         field was empty.
   * @see Converter
   */
   ...
   * @param name The actual name of the value.
   * @param converter The converter to convert the String into the Object.
   * @param defaultValue The String to convert if the original conversion failed
   ...
   * @param name The actual name of the value.
   * @param converter The converter to convert the String into the Object.
   * @param defaultValue The Object to return if the original conversion failed
   *          or the field was empty.
   * @return The object.
   * @see Converter
   */
   ...
   * @param area The area name.
   * @param name The actual name.
   * @param converter The converter to convert the result.
   * @param <T> The type of the result.
  ...
  /**
   * Tests whether the String at the given field can be converted via the given
   * converter.
   * 
   * @param <T> The type of the conversion.
   * @param area The area name. The name in [box brackets].
   * @param name The actual name of the value.
   * @param converter The converter to test the String for.
  ...
  /**
   * Returns a field interpreted as an array of arbitrary objects. The original
   * String is split by the delimiter and the results are converted via the
   * given converter.
   * 
   * @param <T> The component type of the resulting array.
   * @param area The area name. The name in [box brackets].
   * @param name The actual name of the value.
   * @param converter The converter for the array.
   ...
   * @param converter The converter to convert the array elements.
   ...
   * @param area The area name. The name in [box brackets].
   * @param name The actual name of the value.
   * @param delimiter The delimiter used to determine fields of the array.
   * @param defaultValue The default value, if the given field does not exist.
   * @return The resulting array.
   */
  ...
  /**
   * Returns a field interpreted as an array. The original String is split by
   * the default delimiter and the results are the resulting Strings. The result
   * will not contain the default delimiter. Note that the Strings of the result
   * will be trimmed.
   * 
   * @param area The area name. The name in [box brackets].
   * @param name The actual name of the value.
   ...
   * Private constructor.
   * 
   * @param s The underlying scanner.
   */
